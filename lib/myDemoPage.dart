...
import 'package:checkout/helpers/contants.dart';
...
class MyDemoPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<PriceItem> _priceItems =shoppinglist;
    ...
    /// their money
    const String _payToName = 'Ruth AI';
    ...
    const _footer = CheckoutPageFooter(
      ...
      note: 'Powered By Ruth AI Checkout',
